...
<style type="text/css">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <span class="nav-link text-uppercase d-inline-block text-uppercase">danh sách CHI PHÍ hàng tháng</span>
      </li>
    </ul>
                        ...
                        <table class="table table-hover text-nowrap">
                          <thead>
                            <tr>
                              ...
                              <th>Chi phí mua sắm tài sản mới</th>
                              <th>Chi phí khấu hao tài sản</th>
                              <th>Chi phí sửa chữa tài sản</th>
                              <th>Tổng</th>
                            </tr>
                          </thead>
                          <tbody>
